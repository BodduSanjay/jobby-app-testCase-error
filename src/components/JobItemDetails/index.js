...
class JobItemDetails extends Component {
  ...
  getJobDetails = async () => {
    ...
    const {params} = match
    const {id} = params
    const jwtTokenJSON = Cookies.get('jwt_token')
    const jwtToken = jwtTokenJSON ? JSON.parse(jwtTokenJSON).jwtToken : null
      ...
      <div className="bg-jobItem-cont">
        <div className="jobItem-cont">
          ...
          <div className="lifeAtCompany-cont">
            <p className="rating-num">{lifeAtCompany.description}</p>
            <img
